...
{
    public partial class Day_Tours : Form
    {
        ...
        public void displayAyuboDriveTaxiService()
        {
            ...
            cmd.CommandText = "select * from [Day Tour Hire Vehicle]";
            cmd.ExecuteNonQuery();
        ...
        private void Day_Tours_Load(object sender, EventArgs e)
        {
        ...
        {
            if (textBox1.Text != "" && comboBox1.Text != "" && textBox2.Text != "" && textBox7.Text != "")
            {
                con.Open();
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "insert into [Day Tour Hire Vehicle] ([Package_No],[Package_type],[Start_KM],[End_KM],[Start_Time],[End_Time]) values ('" + textBox1.Text + "' , '" + comboBox1.Text + "','" + int.Parse(textBox2.Text) + "','" + int.Parse(textBox7.Text) + "','" + dateTimePicker1.Value + "','" + dateTimePicker2.Value + "')";
                cmd.ExecuteNonQuery();
